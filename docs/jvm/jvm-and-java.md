...
- [1. JVM 如何执行方法调用](#1-jvm-如何执行方法调用)
  - [1.1. 静态绑定和动态绑定](#11-静态绑定和动态绑定)
  - [1.2. 调用指令的符号引用](#12-调用指令的符号引用)
  - [1.3. 虚方法调用](#13-虚方法调用)
  - [1.4. 方法表](#14-方法表)
  - [1.5. 内联缓存](#15-内联缓存)
- [2. JVM 如何处理异常](#2-jvm-如何处理异常)
  - [2.1. JVM 如何捕获异常](#21-jvm-如何捕获异常)
  - [2.2. Java 7 的 Supressed 异常以及语法糖](#22-java-7-的-supressed-异常以及语法糖)
- [3. JVM 如何实现反射](#3-jvm-如何实现反射)
- [4. 参考资料](#4-参考资料)
...
### 2.2. Java 7 的 Supressed 异常以及语法糖
