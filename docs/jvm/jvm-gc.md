...
- [1. 对象活着吗](#1-对象活着吗)
  ...
  - [1.3. 引用类型](#13-引用类型)
  - [1.4. 方法区的回收](#14-方法区的回收)
  - [1.5. finalize()](#15-finalize)
- [2. 垃圾收集算法](#2-垃圾收集算法)
  - [2.1. 垃圾收集性能](#21-垃圾收集性能)
  - [2.2. 标记 - 清除（Mark-Sweep）](#22-标记---清除mark-sweep)
  - [2.3. 标记 - 整理（Mark-Compact）](#23-标记---整理mark-compact)
  - [2.4. 复制（Copying）](#24-复制copying)
  - [2.5. 分代收集](#25-分代收集)
- [3. 垃圾收集器](#3-垃圾收集器)
  - [3.1. 串行收集器](#31-串行收集器)
  - [3.2. 并行收集器](#32-并行收集器)
  - [3.3. 并发标记清除收集器](#33-并发标记清除收集器)
  - [3.4. G1 收集器](#34-g1-收集器)
  - [3.5. 总结](#35-总结)
- [4. 内存分配与回收策略](#4-内存分配与回收策略)
  - [4.1. Minor GC](#41-minor-gc)
  - [4.2. Full GC](#42-full-gc)
- [5. 参考资料](#5-参考资料)
...
<div align="center">
<img src="http://dunwu.test.upcdn.net/cs/java/javacore/jvm/jvm-gc-parallel.jpg" />
...
<div align="center">
<img src="http://dunwu.test.upcdn.net/cs/java/javacore/jvm/jvm-gc-cms.jpg" />
<p>CMS 收集器运行示意图</p>
</div>
...
<div align="center">
<img src="http://dunwu.test.upcdn.net/cs/java/javacore/jvm/jvm-gc-par-new.jpg" />
<p>ParNew 收集器运行示意图</p>
</div>
...
<div align="center">
<img src="http://dunwu.test.upcdn.net/cs/java/javacore/jvm/jvm-gc-g1.jpg" />
<p>G1 收集器运行示意图</p>
</div>
