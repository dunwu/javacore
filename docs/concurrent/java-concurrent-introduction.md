...
>
> **_关键词：`进程`、`线程`、`安全性`、`活跃性`、`性能`、`死锁`、`饥饿`、`上下文切换`_**
...
- [3. 并发安全性问题](#3-并发安全性问题)
  - [3.1. 什么是线程安全](#31-什么是线程安全)
  - [3.2. 缓存导致的可见性问题](#32-缓存导致的可见性问题)
  - [3.3. 线程切换带来的原子性问题](#33-线程切换带来的原子性问题)
  - [3.4. 编译优化带来的有序性问题](#34-编译优化带来的有序性问题)
  - [3.5. 保证并发安全的思路](#35-保证并发安全的思路)
- [4. 活跃性问题](#4-活跃性问题)
