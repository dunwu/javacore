...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/f26a824c80e249fa90700ae8dd371b22.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/bfdb6709c1be44a0981408d13cd2fac8.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/6594c442382648b0b04c889678732cb4.png)
**（4）年轻代回收之后**

一次年轻代垃圾收集之后，Eden 区和其中一个 Survivor 区被清空。

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/66bc47278c064416b9d5438406f4a884.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/601e7b8b564940f9b2f34f5eda67beae.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/35e5c15fed2d48f68101a3e18483ae69.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/499edc3070404b41a764d977ba6399fa.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/955d51a0b3f24f498de3236434c39b38.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/b1ba85d509184ae3a6d676ff39ea4044.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/a01bf811fb7847fabfd35e9a46abbd2a.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/dc0fcf476e9548d8a994ec89ade12901.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/1493fe7aba584967838271d8f705ad07.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/51dc6d0516234975a1067d07e548f697.png)

**（2）并发标记阶段**

如果发现空区域 (“X”标示的），在重新标记阶段它们会被马上清除掉。当然，决定活性的审计信息也在此时被计算。

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/7a1ed0624c28490d96120b3f8a2084be.png)

**（3）重新标记阶段**

空的区域被清除和回收掉。所有区域的活性在此时计算。

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/ea1d21e7ed31449eaff1fa8a5ea2e842.png)

**（4）复制/清理阶段**

G1 选择活性最低的区域，这些区域能够以最快的速度回收。然后这些区域会在年轻代垃圾回收过程中被回收。在日志中被指示为* [GC pause (mixed)]*。所以年轻代和年老代在同一时间被回收。

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/60c138bacee94e70907a7043e4d8a33a.png)

**（5）复制/清理阶段之后**

被选择的区域已经被回收和压缩到图中显示的深蓝色区和深绿色区中。

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2026/02/d31a3a3d726248cbad7c90ae56cdaf35.png)
...
根据应用特点选择 GC：低延迟用 G1/ZGC，高吞吐量用 Parallel，小内存用 Serial。
...
1. **JDK 11+ 优先考虑 G1**：默认 GC，平衡延迟和吞吐量。
2. **关注 GC 停顿时间而非总时间**：用户体验取决于单次停顿的延迟。
3. **避免手动调用 `System.gc()`**：不可靠且可能触发 Full GC。
4. **调整新生代比例**：`-Xmn` 影响 Minor GC 频率和停顿时间。
5. **开启 GC 日志**：这是调优的基础，没有日志无法做有效分析。

## 常见问题

### Q1：Minor GC 和 Full GC 有什么区别？

- **Minor GC**：回收新生代，频繁且快速。
- **Full GC**：回收整个堆（包括老年代），耗时长，应尽量避免。

### Q2：G1 和 ZGC 有什么区别？

G1 通过 Region 化堆和混合回收平衡延迟与吞吐量；ZGC 通过读屏障和染色指针实现亚毫秒级停顿，适合对延迟极度敏感的场景。

### Q3：什么时候会发生 Full GC？

老年代空间不足、方法区空间不足、显式调用 `System.gc()`、CMS 并发失败等情况都会触发 Full GC。
