...
public class FileUtil {
	...
	/**
	 * 获得目录下所有的文件绝对路径（包含子目录） 如果hasFolder为true，会包含目录路径
	 * @param path
	 * @param hasFolder
	 * @return
	 */
	...
	private static void collectFilesAndFolders(final File folder, final boolean hasFolder, LinkedList<File> folderList,
