...
public class Countries {
    ...
    public static final String[][] DATA = {
        ...
        { "ETHIOPIA", "Addis Ababa" }, { "GABON", "Libreville" }, { "THE GAMBIA", "Banjul" }, { "GHANA", "Accra" },
        { "GUINEA", "Conakry" }, { "BISSAU", "Bissau" }, { "COTE D'IVOIR (IVORY COAST)", "Yamoussoukro" },
        { "KENYA", "Nairobi" }, { "LESOTHO", "Maseru" }, { "LIBERIA", "Monrovia" }, { "LIBYA", "Tripoli" },
        ...
        { "GEORGIA", "Tbilisi" }, { "KAZAKSTAN", "Almaty" }, { "KYRGYZSTAN", "Alma-Ata" },
 ...
 * BULGARIA=Sofia, BURKINA FASO=Ouagadougou, BURUNDI=Bujumbura, CAMEROON=Yaounde, CAPE
 * VERDE=Praia, CENTRAL AFRICAN REPUBLIC=Bangui} [ALGERIA, ANGOLA, BENIN, BOTSWANA,
 * BULGARIA, BURKINA FASO, BURUNDI, CAMEROON, CAPE VERDE, CENTRAL AFRICAN REPUBLIC]
 * {BENIN=Porto-Novo, ANGOLA=Luanda, ALGERIA=Algiers} {ALGERIA=Algiers, ANGOLA=Luanda,
 ...
 * BOTSWANA, BENIN, ANGOLA, ALGERIA] [ALGERIA, ANGOLA, BENIN, BOTSWANA, BULGARIA,
 * BURKINA FASO] [ALGERIA, ANGOLA, BENIN, BOTSWANA, BULGARIA, BURKINA FASO] [ALGERIA,
 * ANGOLA, BENIN, BOTSWANA, BULGARIA, BURKINA FASO] [ALGERIA, ANGOLA, BENIN, BOTSWANA,
